 ...
 * </p>
 * <ul>
 *   <li>{@link cafeV.dsl.vforms.vformDSL.EnumOption#getStringData <em>String Data</em>}</li>
 *   <li>{@link cafeV.dsl.vforms.vformDSL.EnumOption#getNumberData <em>Number Data</em>}</li>
 * </ul>
 *
 * @see cafeV.dsl.vforms.vformDSL.VformDSLPackage#getEnumOption()
 * @model
 * @generated
 */
public interface EnumOption extends EObject
{
   ...
   * @see cafeV.dsl.vforms.vformDSL.VformDSLPackage#getEnumOption_StringData()
   * @model unique="false"
   * @generated
   */
   ...
   * @see cafeV.dsl.vforms.vformDSL.VformDSLPackage#getEnumOption_NumberData()
   * @model unique="false"
   * @generated
   */
