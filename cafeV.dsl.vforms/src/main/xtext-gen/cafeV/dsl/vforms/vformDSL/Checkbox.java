 ...
 * </p>
 * <ul>
 *   <li>{@link cafeV.dsl.vforms.vformDSL.Checkbox#getInputName <em>Input Name</em>}</li>
 * </ul>
 *
 * @see cafeV.dsl.vforms.vformDSL.VformDSLPackage#getCheckbox()
 * @model
 * @generated
 */
public interface Checkbox extends EObject
{
   ...
   * @see cafeV.dsl.vforms.vformDSL.VformDSLPackage#getCheckbox_InputName()
   * @model
   * @generated
   */
  String getInputName();
  ...
  /**
   * Sets the value of the '{@link cafeV.dsl.vforms.vformDSL.Checkbox#getInputName <em>Input Name</em>}' attribute.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
