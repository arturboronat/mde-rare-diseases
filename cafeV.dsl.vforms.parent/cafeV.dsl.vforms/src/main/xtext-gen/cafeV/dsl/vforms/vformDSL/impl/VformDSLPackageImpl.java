...
public class VformDSLPackageImpl extends EPackageImpl implements VformDSLPackage
{
   ...
   * @see cafeV.dsl.vforms.vformDSL.VformDSLPackage#eNS_URI
   * @see #init()
   * @generated
   */
  ...
  public void initializePackageContents()
  {
    ...
    initEClass(numberEClass, cafeV.dsl.vforms.vformDSL.Number.class, "Number", !IS_ABSTRACT, !IS_INTERFACE, IS_GENERATED_INSTANCE_CLASS);
    initEAttribute(getNumber_InputName(), ecorePackage.getEString(), "inputName", null, 0, 1, cafeV.dsl.vforms.vformDSL.Number.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
    ...
    initEAttribute(getEnumOption_NumberData(), ecorePackage.getEString(), "numberData", null, 0, -1, EnumOption.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, !IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
