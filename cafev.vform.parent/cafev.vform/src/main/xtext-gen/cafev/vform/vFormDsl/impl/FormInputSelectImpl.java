 ...
 * </p>
 * <ul>
 *   <li>{@link cafev.vform.vFormDsl.impl.FormInputSelectImpl#getId <em>Id</em>}</li>
...
public class FormInputSelectImpl extends FormInputImpl implements FormInputSelect
{
  ...
  public void setId(String newId)
  {
    ...
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, VFormDslPackage.FORM_INPUT_SELECT__ID, oldId, id));
  }
  ...
  public Object eGet(int featureID, boolean resolve, boolean coreType)
  {
    switch (featureID)
    {
      case VFormDslPackage.FORM_INPUT_SELECT__ID:
        return getId();
