...
public class VFormDslParser extends AbstractContentAssistParser {
	...
	public static final class NameMappings {
		...
		private static void init(ImmutableMap.Builder<AbstractElement, String> builder, VFormDslGrammarAccess grammarAccess) {
			...
			builder.put(grammarAccess.getFormInputSearchAccess().getGroup_17(), "rule__FormInputSearch__Group_17__0");
			...
			builder.put(grammarAccess.getFormInputBasicAccess().getQCAssignment_7(), "rule__FormInputBasic__QCAssignment_7");
			builder.put(grammarAccess.getFormInputBasicAccess().getTypeAssignment_11(), "rule__FormInputBasic__TypeAssignment_11");
			builder.put(grammarAccess.getFormInputRangeAccess().getNameAssignment_3(), "rule__FormInputRange__NameAssignment_3");
			builder.put(grammarAccess.getFormInputRangeAccess().getQCAssignment_7(), "rule__FormInputRange__QCAssignment_7");
			builder.put(grammarAccess.getFormInputRangeAccess().getMinAssignment_15(), "rule__FormInputRange__MinAssignment_15");
			builder.put(grammarAccess.getFormInputRangeAccess().getMaxAssignment_19(), "rule__FormInputRange__MaxAssignment_19");
			builder.put(grammarAccess.getFormInputSelectAccess().getNameAssignment_3(), "rule__FormInputSelect__NameAssignment_3");
			builder.put(grammarAccess.getFormInputSelectAccess().getQCAssignment_7(), "rule__FormInputSelect__QCAssignment_7");
			builder.put(grammarAccess.getFormInputSelectAccess().getOptionAssignment_15(), "rule__FormInputSelect__OptionAssignment_15");
			...
			builder.put(grammarAccess.getFormInputSearchAccess().getQCAssignment_7(), "rule__FormInputSearch__QCAssignment_7");
			builder.put(grammarAccess.getFormInputSearchAccess().getDataAssignment_16(), "rule__FormInputSearch__DataAssignment_16");
			builder.put(grammarAccess.getFormInputSearchAccess().getDataAssignment_17_1(), "rule__FormInputSearch__DataAssignment_17_1");
