...
public class VFormDslParser extends AbstractContentAssistParser {
	...
	public static final class NameMappings {
		...
		private static void init(ImmutableMap.Builder<AbstractElement, String> builder, VFormDslGrammarAccess grammarAccess) {
			...
			builder.put(grammarAccess.getFormInputSearchAccess().getGroup_13(), "rule__FormInputSearch__Group_13__0");
			...
			builder.put(grammarAccess.getFormInputBasicAccess().getTypeAssignment_7(), "rule__FormInputBasic__TypeAssignment_7");
			builder.put(grammarAccess.getFormInputRangeAccess().getNameAssignment_3(), "rule__FormInputRange__NameAssignment_3");
			builder.put(grammarAccess.getFormInputRangeAccess().getMinAssignment_11(), "rule__FormInputRange__MinAssignment_11");
			builder.put(grammarAccess.getFormInputRangeAccess().getMaxAssignment_15(), "rule__FormInputRange__MaxAssignment_15");
			builder.put(grammarAccess.getFormInputSelectAccess().getNameAssignment_3(), "rule__FormInputSelect__NameAssignment_3");
			builder.put(grammarAccess.getFormInputSelectAccess().getOptionAssignment_11(), "rule__FormInputSelect__OptionAssignment_11");
			...
			builder.put(grammarAccess.getFormInputSearchAccess().getDataAssignment_12(), "rule__FormInputSearch__DataAssignment_12");
			builder.put(grammarAccess.getFormInputSearchAccess().getDataAssignment_13_1(), "rule__FormInputSearch__DataAssignment_13_1");
