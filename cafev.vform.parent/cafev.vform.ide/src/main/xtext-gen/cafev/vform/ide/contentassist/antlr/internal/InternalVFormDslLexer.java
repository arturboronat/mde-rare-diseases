...
public class InternalVFormDslLexer extends Lexer {
    ...
    public final void mRULE_LAYOUT() throws RecognitionException {
        try {
            ...
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // InternalVFormDsl.g:4767:13: ( ( '\"horizontal\"' | '\"vertical\"' ) )
            // InternalVFormDsl.g:4767:15: ( '\"horizontal\"' | '\"vertical\"' )
            {
            // InternalVFormDsl.g:4767:15: ( '\"horizontal\"' | '\"vertical\"' )
            int alt1=2;
            ...
            switch (alt1) {
                case 1 :
                    // InternalVFormDsl.g:4767:16: '\"horizontal\"'
                    {
                    match("\"horizontal\""); 
                    ...
                    break;
                case 2 :
                    // InternalVFormDsl.g:4767:31: '\"vertical\"'
                    {
                    match("\"vertical\""); 
    ...
    public final void mRULE_BASICINPUT() throws RecognitionException {
        try {
            ...
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // InternalVFormDsl.g:4769:17: ( ( '\"text\"' | '\"checkbox\"' | '\"numberr\"' | '\"date\"' ) )
            // InternalVFormDsl.g:4769:19: ( '\"text\"' | '\"checkbox\"' | '\"numberr\"' | '\"date\"' )
            {
            // InternalVFormDsl.g:4769:19: ( '\"text\"' | '\"checkbox\"' | '\"numberr\"' | '\"date\"' )
            int alt2=4;
            ...
            switch (alt2) {
                case 1 :
                    // InternalVFormDsl.g:4769:20: '\"text\"'
                    {
                    match("\"text\""); 
                    ...
                    break;
                case 2 :
                    // InternalVFormDsl.g:4769:29: '\"checkbox\"'
                    {
                    match("\"checkbox\""); 
                    ...
                    break;
                case 3 :
                    // InternalVFormDsl.g:4769:42: '\"numberr\"'
                    {
                    match("\"numberr\""); 
                    ...
                    break;
                case 4 :
                    // InternalVFormDsl.g:4769:54: '\"date\"'
                    {
                    match("\"date\""); 
    ...
    public final void mRULE_ID() throws RecognitionException {
        try {
            int _type = RULE_ID;
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // InternalVFormDsl.g:4771:9: ( ( '^' )? ( 'a' .. 'z' | 'A' .. 'Z' | '_' ) ( 'a' .. 'z' | 'A' .. 'Z' | '_' | '0' .. '9' )* )
            // InternalVFormDsl.g:4771:11: ( '^' )? ( 'a' .. 'z' | 'A' .. 'Z' | '_' ) ( 'a' .. 'z' | 'A' .. 'Z' | '_' | '0' .. '9' )*
            {
            // InternalVFormDsl.g:4771:11: ( '^' )?
            int alt3=2;
            ...
            // InternalVFormDsl.g:4771:40: ( 'a' .. 'z' | 'A' .. 'Z' | '_' | '0' .. '9' )*
            loop4:
            do {
                int alt4=2;
    ...
    public final void mRULE_INT() throws RecognitionException {
        try {
            int _type = RULE_INT;
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // InternalVFormDsl.g:4773:10: ( ( '0' .. '9' )+ )
            // InternalVFormDsl.g:4773:12: ( '0' .. '9' )+
            {
            // InternalVFormDsl.g:4773:12: ( '0' .. '9' )+
            int cnt5=0;
            loop5:
            do {
                ...
                switch (alt5) {
            	case 1 :
            	    // InternalVFormDsl.g:4773:13: '0' .. '9'
            	    {
            	    matchRange('0','9'); 
    ...
    public final void mRULE_STRING() throws RecognitionException {
        try {
            ...
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // InternalVFormDsl.g:4775:13: ( ( '\"' ( '\\\\' . | ~ ( ( '\\\\' | '\"' ) ) )* '\"' | '\\'' ( '\\\\' . | ~ ( ( '\\\\' | '\\'' ) ) )* '\\'' ) )
            // InternalVFormDsl.g:4775:15: ( '\"' ( '\\\\' . | ~ ( ( '\\\\' | '\"' ) ) )* '\"' | '\\'' ( '\\\\' . | ~ ( ( '\\\\' | '\\'' ) ) )* '\\'' )
            {
            // InternalVFormDsl.g:4775:15: ( '\"' ( '\\\\' . | ~ ( ( '\\\\' | '\"' ) ) )* '\"' | '\\'' ( '\\\\' . | ~ ( ( '\\\\' | '\\'' ) ) )* '\\'' )
            int alt8=2;
            ...
            switch (alt8) {
                case 1 :
                    // InternalVFormDsl.g:4775:16: '\"' ( '\\\\' . | ~ ( ( '\\\\' | '\"' ) ) )* '\"'
                    {
                    match('\"'); 
                    // InternalVFormDsl.g:4775:20: ( '\\\\' . | ~ ( ( '\\\\' | '\"' ) ) )*
                    loop6:
                    do {
                        int alt6=3;
                    ...
                    break;
                case 2 :
                    // InternalVFormDsl.g:4775:48: '\\'' ( '\\\\' . | ~ ( ( '\\\\' | '\\'' ) ) )* '\\''
                    {
                    match('\''); 
                    // InternalVFormDsl.g:4775:53: ( '\\\\' . | ~ ( ( '\\\\' | '\\'' ) ) )*
                    loop7:
                    do {
                        int alt7=3;
    ...
    public final void mRULE_ML_COMMENT() throws RecognitionException {
        try {
            ...
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // InternalVFormDsl.g:4777:17: ( '/*' ( options {greedy=false; } : . )* '*/' )
            // InternalVFormDsl.g:4777:19: '/*' ( options {greedy=false; } : . )* '*/'
            {
            match("/*"); 

            // InternalVFormDsl.g:4777:24: ( options {greedy=false; } : . )*
            loop9:
            do {
                int alt9=2;
    ...
    public final void mRULE_SL_COMMENT() throws RecognitionException {
        try {
            ...
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // InternalVFormDsl.g:4779:17: ( '//' (~ ( ( '\\n' | '\\r' ) ) )* ( ( '\\r' )? '\\n' )? )
            // InternalVFormDsl.g:4779:19: '//' (~ ( ( '\\n' | '\\r' ) ) )* ( ( '\\r' )? '\\n' )?
            {
            match("//"); 

            // InternalVFormDsl.g:4779:24: (~ ( ( '\\n' | '\\r' ) ) )*
            loop10:
            do {
                int alt10=2;
    ...
    public final void mRULE_WS() throws RecognitionException {
        try {
            int _type = RULE_WS;
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // InternalVFormDsl.g:4781:9: ( ( ' ' | '\\t' | '\\r' | '\\n' )+ )
            // InternalVFormDsl.g:4781:11: ( ' ' | '\\t' | '\\r' | '\\n' )+
            {
            // InternalVFormDsl.g:4781:11: ( ' ' | '\\t' | '\\r' | '\\n' )+
            int cnt13=0;
            loop13:
    ...
    public final void mRULE_ANY_OTHER() throws RecognitionException {
        try {
            ...
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // InternalVFormDsl.g:4783:16: ( . )
            // InternalVFormDsl.g:4783:18: .
            {
            matchAny(); 
