...
public class InternalVFormDslLexer extends Lexer {
    ...
    public final void mRULE_BOOLEAN() throws RecognitionException {
        try {
            ...
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // InternalVFormDsl.g:5259:14: ( ( 'true' | 'false' ) )
            // InternalVFormDsl.g:5259:16: ( 'true' | 'false' )
            {
            // InternalVFormDsl.g:5259:16: ( 'true' | 'false' )
            int alt1=2;
            ...
            switch (alt1) {
                case 1 :
                    // InternalVFormDsl.g:5259:17: 'true'
                    {
                    match("true"); 
                    ...
                    break;
                case 2 :
                    // InternalVFormDsl.g:5259:24: 'false'
                    {
                    match("false"); 
    ...
    public final void mRULE_LAYOUT() throws RecognitionException {
        try {
            ...
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // InternalVFormDsl.g:5261:13: ( ( '\"horizontal\"' | '\"vertical\"' ) )
            // InternalVFormDsl.g:5261:15: ( '\"horizontal\"' | '\"vertical\"' )
            {
            // InternalVFormDsl.g:5261:15: ( '\"horizontal\"' | '\"vertical\"' )
            int alt2=2;
            ...
            switch (alt2) {
                case 1 :
                    // InternalVFormDsl.g:5261:16: '\"horizontal\"'
                    {
                    match("\"horizontal\""); 
                    ...
                    break;
                case 2 :
                    // InternalVFormDsl.g:5261:31: '\"vertical\"'
                    {
                    match("\"vertical\""); 
    ...
    public final void mRULE_BASICINPUT() throws RecognitionException {
        try {
            ...
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // InternalVFormDsl.g:5263:17: ( ( '\"text\"' | '\"checkbox\"' | '\"number\"' | '\"date\"' ) )
            // InternalVFormDsl.g:5263:19: ( '\"text\"' | '\"checkbox\"' | '\"number\"' | '\"date\"' )
            {
            // InternalVFormDsl.g:5263:19: ( '\"text\"' | '\"checkbox\"' | '\"number\"' | '\"date\"' )
            int alt3=4;
            ...
            switch (alt3) {
                case 1 :
                    // InternalVFormDsl.g:5263:20: '\"text\"'
                    {
                    match("\"text\""); 
                    ...
                    break;
                case 2 :
                    // InternalVFormDsl.g:5263:29: '\"checkbox\"'
                    {
                    match("\"checkbox\""); 
                    ...
                    break;
                case 3 :
                    // InternalVFormDsl.g:5263:42: '\"number\"'
                    {
                    match("\"number\""); 
                    ...
                    break;
                case 4 :
                    // InternalVFormDsl.g:5263:53: '\"date\"'
                    {
                    match("\"date\""); 
    ...
    public final void mRULE_ID() throws RecognitionException {
        try {
            int _type = RULE_ID;
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // InternalVFormDsl.g:5265:9: ( ( '^' )? ( 'a' .. 'z' | 'A' .. 'Z' | '_' ) ( 'a' .. 'z' | 'A' .. 'Z' | '_' | '0' .. '9' )* )
            // InternalVFormDsl.g:5265:11: ( '^' )? ( 'a' .. 'z' | 'A' .. 'Z' | '_' ) ( 'a' .. 'z' | 'A' .. 'Z' | '_' | '0' .. '9' )*
            {
            // InternalVFormDsl.g:5265:11: ( '^' )?
            int alt4=2;
            ...
            // InternalVFormDsl.g:5265:40: ( 'a' .. 'z' | 'A' .. 'Z' | '_' | '0' .. '9' )*
            loop5:
            do {
                int alt5=2;
    ...
    public final void mRULE_INT() throws RecognitionException {
        try {
            int _type = RULE_INT;
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // InternalVFormDsl.g:5267:10: ( ( '0' .. '9' )+ )
            // InternalVFormDsl.g:5267:12: ( '0' .. '9' )+
            {
            // InternalVFormDsl.g:5267:12: ( '0' .. '9' )+
            int cnt6=0;
            loop6:
            do {
                ...
                switch (alt6) {
            	case 1 :
            	    // InternalVFormDsl.g:5267:13: '0' .. '9'
            	    {
            	    matchRange('0','9'); 
    ...
    public final void mRULE_STRING() throws RecognitionException {
        try {
            ...
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // InternalVFormDsl.g:5269:13: ( ( '\"' ( '\\\\' . | ~ ( ( '\\\\' | '\"' ) ) )* '\"' | '\\'' ( '\\\\' . | ~ ( ( '\\\\' | '\\'' ) ) )* '\\'' ) )
            // InternalVFormDsl.g:5269:15: ( '\"' ( '\\\\' . | ~ ( ( '\\\\' | '\"' ) ) )* '\"' | '\\'' ( '\\\\' . | ~ ( ( '\\\\' | '\\'' ) ) )* '\\'' )
            {
            // InternalVFormDsl.g:5269:15: ( '\"' ( '\\\\' . | ~ ( ( '\\\\' | '\"' ) ) )* '\"' | '\\'' ( '\\\\' . | ~ ( ( '\\\\' | '\\'' ) ) )* '\\'' )
            int alt9=2;
            ...
            switch (alt9) {
                case 1 :
                    // InternalVFormDsl.g:5269:16: '\"' ( '\\\\' . | ~ ( ( '\\\\' | '\"' ) ) )* '\"'
                    {
                    match('\"'); 
                    // InternalVFormDsl.g:5269:20: ( '\\\\' . | ~ ( ( '\\\\' | '\"' ) ) )*
                    loop7:
                    do {
                        int alt7=3;
                    ...
                    break;
                case 2 :
                    // InternalVFormDsl.g:5269:48: '\\'' ( '\\\\' . | ~ ( ( '\\\\' | '\\'' ) ) )* '\\''
                    {
                    match('\''); 
                    // InternalVFormDsl.g:5269:53: ( '\\\\' . | ~ ( ( '\\\\' | '\\'' ) ) )*
                    loop8:
                    do {
                        int alt8=3;
    ...
    public final void mRULE_ML_COMMENT() throws RecognitionException {
        try {
            ...
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // InternalVFormDsl.g:5271:17: ( '/*' ( options {greedy=false; } : . )* '*/' )
            // InternalVFormDsl.g:5271:19: '/*' ( options {greedy=false; } : . )* '*/'
            {
            match("/*"); 

            // InternalVFormDsl.g:5271:24: ( options {greedy=false; } : . )*
            loop10:
            do {
                int alt10=2;
    ...
    public final void mRULE_SL_COMMENT() throws RecognitionException {
        try {
            ...
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // InternalVFormDsl.g:5273:17: ( '//' (~ ( ( '\\n' | '\\r' ) ) )* ( ( '\\r' )? '\\n' )? )
            // InternalVFormDsl.g:5273:19: '//' (~ ( ( '\\n' | '\\r' ) ) )* ( ( '\\r' )? '\\n' )?
            {
            match("//"); 

            // InternalVFormDsl.g:5273:24: (~ ( ( '\\n' | '\\r' ) ) )*
            loop11:
            do {
                int alt11=2;
    ...
    public final void mRULE_WS() throws RecognitionException {
        try {
            int _type = RULE_WS;
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // InternalVFormDsl.g:5275:9: ( ( ' ' | '\\t' | '\\r' | '\\n' )+ )
            // InternalVFormDsl.g:5275:11: ( ' ' | '\\t' | '\\r' | '\\n' )+
            {
            // InternalVFormDsl.g:5275:11: ( ' ' | '\\t' | '\\r' | '\\n' )+
            int cnt14=0;
            loop14:
    ...
    public final void mRULE_ANY_OTHER() throws RecognitionException {
        try {
            ...
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // InternalVFormDsl.g:5277:16: ( . )
            // InternalVFormDsl.g:5277:18: .
            {
            matchAny(); 
