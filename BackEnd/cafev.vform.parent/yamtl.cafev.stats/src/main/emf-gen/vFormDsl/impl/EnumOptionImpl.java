 ...
 * </p>
 * <ul>
 *   <li>{@link vFormDsl.impl.EnumOptionImpl#getData <em>Data</em>}</li>
 * </ul>
 *
 * @generated
 */
public class EnumOptionImpl extends OptionImpl implements EnumOption {
	/**
	...
	public EList<OptionItem> getData() {
		if (data == null) {
			data = new EObjectContainmentEList<OptionItem>(OptionItem.class, this, VFormDslPackage.ENUM_OPTION__DATA);
		}
		return data;
	}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case VFormDslPackage.ENUM_OPTION__DATA:
