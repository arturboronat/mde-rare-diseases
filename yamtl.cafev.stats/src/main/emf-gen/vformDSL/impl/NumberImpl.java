 ...
 * </p>
 * <ul>
 *   <li>{@link vformDSL.impl.NumberImpl#getInputName <em>Input Name</em>}</li>
 * </ul>
 *
 * @generated
 */
public class NumberImpl extends MinimalEObjectImpl.Container implements vformDSL.Number {
	/**
	...
	protected EClass eStaticClass() {
		return VformDSLPackage.Literals.NUMBER;
	}
	...
	public void setInputName(String newInputName) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, VformDSLPackage.NUMBER__INPUT_NAME, oldInputName, inputName));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case VformDSLPackage.NUMBER__INPUT_NAME:
				return getInputName();
		}
