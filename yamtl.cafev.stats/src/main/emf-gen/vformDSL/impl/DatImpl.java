...
/**
 * <!-- begin-user-doc -->
 * An implementation of the model object '<em><b>Dat</b></em>'.
 * <!-- end-user-doc -->
 * <p>
 * The following features are implemented:
 * </p>
 * <ul>
 *   <li>{@link vformDSL.impl.DatImpl#getInputName <em>Input Name</em>}</li>
 * </ul>
 *
 * @generated
 */
public class DatImpl extends MinimalEObjectImpl.Container implements Dat {
	/**
	...
	protected EClass eStaticClass() {
		return VformDSLPackage.Literals.DAT;
	}
	...
	public void setInputName(String newInputName) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, VformDSLPackage.DAT__INPUT_NAME, oldInputName, inputName));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case VformDSLPackage.DAT__INPUT_NAME:
				return getInputName();
		}
